...
<?php $__env->startSection('content'); ?>
    <div class="sell" style="background-image:url('/home/images/dealbuy.png');background-repeat:no-repeat;background-position:800px 400px;">
        <form  class="sell" id="sellform" method="post" action="<?php echo e(action('DealController@store')); ?>" enctype="multipart/form-data">
            ...
            <div class="sell-son">
                ...
                <?php $__currentLoopData = $cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="sell-son-right">
                        <input type="radio" value="<?php echo e($v['id']); ?>" name="deal_cate" class="sell-son-mpzl">
                        <span style="margin-left:5px"><?php echo e($v['name']); ?></span>
