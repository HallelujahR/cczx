<?php $__env->startSection('title'); ?>
    <title><?php echo e($cate->cate); ?>[传承网]</title>
    ...
    <div id="bbs_con">
        ...
        <div class="navigation">
            ...
            <div style="float: left;font-size: 14px;line-height: 25px ;height: 25px;">
                <a href="/">传承网</a> →
                <span><?php echo e($cate->cate); ?></span> →
                <span>帖子列表</span>
            </div>
        </div>
        <br>
     ...
     -->
            <div class="plate">
                <a id="plate_a" href="<?php echo e(action('TopicController@publish',$cate->id)); ?>">
                    发表话题
                </a>
            </div>
        ...
        <div class="table">
            ...
            <div class="table_title">
                <div class="table_head">
                    ...
                    <div class="table_head_n n5">发布于</div>
			...
			<div class="table_tr_n r1">
				<a href="" target="_blank">
                    ...
                    <div class="table_tr_n r2">
                        <a href="<?php echo e(action('TopicController@detail',$post->id)); ?>" title="<?php echo e($post->title); ?>"><?php echo e($post->title); ?></a>
                        <!-- 		  		<span>
                                              <img border="0" class="imgSmall" src="/home/images/ztop.gif">
                                          </span> -->
                    </div>

                    <div class="table_tr_n r3"><?php echo e($post->replies->count('id')); ?></div>

                    <div class="table_tr_n r4"><?php echo e($post->access_count); ?></div>
                    ...
                    <div class="table_tr_n r6">
                        <a href="/personal/<?php echo e($post->user->id); ?>" target="_blank"><?php echo e($post->user->name); ?></a>
                    </div>
