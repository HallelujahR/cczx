            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ url('/admin') }}"><i class="fa fa-home"></i>主页</a>
                  </li>
                  ...
                  <li><a><i class="fa fa-user"></i> 前台用户管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{ action('Admin\HomeUserController@cardAuth')}}">审核认证会员</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-align-left"></i> 公告模块管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('Admin\NoticeController@index') }}">浏览公告列表</a></li>
                    </ul>
                  </li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-rmb"></i> 买卖盘种类管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('Admin\DealCateController@index') }}">浏览买卖盘种类</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-pie-chart"></i> 话题分类模块管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('Admin\TopicController@index') }}">浏览添加话题分类</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-male"></i> 话题交流模块管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('Admin\TopicController@post') }}">浏览话题交流帖子</a></li>
                    </ul>
                  </li>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cog"></i> 网站管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{ action('Admin\ConfigController@hotSearch') }}">热搜管理</a></li>
                      <li><a href="{{ action('Admin\SliderController@index')}}">轮播图管理</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="" id="tanchutou">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="{{ action('Admin\AdminUserController@changePwd') }}"> 修改密码</a></li>
