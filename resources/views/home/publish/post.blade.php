...
<div id="article_con">
	...
	<!-- 主体表单模块 -->
	<form id="form" class="form-horizontal" action="{{ action('PublishController@storePost') }}" method="post">
		<div class="order">
		   	<span class="line"></span>
		   	<span class="txt">发布帖子</span>
		   	<span class="line"></span>
		</div>
        {{ csrf_field() }}
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="name" name="name" placeholder="请输入您的帖子标题">
			</div>
